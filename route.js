...
Rules: 5-8 insights, >=1 moon, >=1 sadhana type. SPECIFIC data refs. Warm coaching tone. Honest scores.`;
  ...
  try {
    ...
    return Response.json({ error: "Analysis failed. Add ANTHROPIC_API_KEY in Vercel Environment Variables." }, { status: 500 });
  }
}
